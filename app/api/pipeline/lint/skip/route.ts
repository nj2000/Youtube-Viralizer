...
import { skipLint } from "@/lib/services/lint-actions";
...
// POST /api/pipeline/lint/skip — advisory skip. The auto-chain already advanced
// past lint; this only nudges the run-detail UI to drop the lint card.
export async function POST(request: NextRequest) {
  ...
  await skipLint({ runId: parsed.data.runId, userId: user.id });

...
import { relockScript } from "@/lib/services/script-mutations";
...
export async function POST(request: NextRequest) {
  ...
  // Destructive: clears script_data so the user can re-pick length/title/hook.
  await relockScript({ runId: parsed.data.runId, userId: user.id });
